...
namespace HMS_project {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class DrugsDataTable : global::System.Data.TypedTableBase<DrugsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DrugsRow AddDrugsRow(int DrugID, string DrugName, int Quantity) {
...
namespace HMS_project.UsersDataSetTableAdapters {
    ...
    public partial class DrugsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Drugs] WHERE (([DrugID] = @Original_DrugID) AND ((@IsNull_Drug" +
                "Name = 1 AND [DrugName] IS NULL) OR ([DrugName] = @Original_DrugName)) AND ((@Is" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Drugs] ([DrugID], [DrugName], [Quantity]) VALUES (@DrugID, @Dr" +
                "ugName, @Quantity);\r\nSELECT DrugID, DrugName, Quantity FROM Drugs WHERE (DrugID " +
                "= @DrugID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Drugs] SET [DrugID] = @DrugID, [DrugName] = @DrugName, [Quantity] = @Quantity WHERE (([DrugID] = @Original_DrugID) AND ((@IsNull_DrugName = 1 AND [DrugName] IS NULL) OR ([DrugName] = @Original_DrugName)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)));
SELECT DrugID, DrugName, Quantity FROM Drugs WHERE (DrugID = @DrugID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HMS_project.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DrugID, DrugName, Quantity FROM dbo.Drugs";
        ...
        public virtual int Fill(UsersDataSet.DrugsDataTable dataTable) {
        ...
        public virtual UsersDataSet.DrugsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsersDataSet.DrugsDataTable dataTable = new UsersDataSet.DrugsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsersDataSet.DrugsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_DrugID, string Original_DrugName, global::System.Nullable<int> Original_Quantity) {
            ...
            if ((Original_DrugName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_DrugName));
            }
        ...
        public virtual int Insert(int DrugID, string DrugName, global::System.Nullable<int> Quantity) {
        ...
        public virtual int Update(int DrugID, string DrugName, global::System.Nullable<int> Quantity, int Original_DrugID, string Original_DrugName, global::System.Nullable<int> Original_Quantity) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_DrugID));
            if ((Original_DrugName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_DrugName));
            }
            if ((Original_Quantity.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string DrugName, global::System.Nullable<int> Quantity, int Original_DrugID, string Original_DrugName, global::System.Nullable<int> Original_Quantity) {
            return this.Update(Original_DrugID, DrugName, Quantity, Original_DrugID, Original_DrugName, Original_Quantity);
        }
    }
